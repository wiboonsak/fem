...
<script>	
	...
	//----------------------
	function check_frmAdministrator() {
			...
			if(name_th ==''){
				...
				if(dataID != ''){
				   ...
				   var nameFunction = 'EditDataAdministrator';
				   var finished_txt = 'แก้ไขข้อมูลสำเร็จแล้ว';	
				   var not_txt = 'ไม่สามารถแก้ไขข้อมูลได้!';	
					
				} else {
				   var nameFunction = 'AddDataAdministrator';
								 ...
								 $.ajax({
									 ...
									 success:function(data2){
										 ...
										 if(data2 > 0){
											  ...
											  setTimeout(function(){ window.location.href = "<?php echo base_url('control/administratorAdd/')?>"+data; }, 2000);	
										 }
									 }
                        		});	
