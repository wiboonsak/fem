<ul class="navbar-nav">
				...
				<li class="has-sub">
					...
					<ul class="visible">
						<li>
							<a href="#">
								<span class="title">รายงานอนุมัติ</span>
							</a>
						</li>
						<li>
							<a href="#">
								<span class="title">รายงานรอดำเนินการ</span>
							</a>
						</li>
						<li>
							<a href="#">
								<span class="title">รายงานไม่อนุมัติ</span>
							</a>
						</li>
						<li>
							<a href="#">
								<span class="title">รายงานคำขอทั้งหมด</span>
							</a>
						</li>
					</ul>
				</li>
