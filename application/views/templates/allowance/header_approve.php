...
<head>
	...
	<title>ระบบงานการเงิน - คณะการจัดการสิ่งแวดล้อม มหาวิทยาลัยสงขลานครินทร์ </title>
...
<?php
//  if (isset($this->session->userdata['logged_in']) && $this->session->userdata['logged_in']['status'] == "approve") {
if (isset($this->session->userdata['logged_in']) && $this->session->userdata['logged_in']['statusApprove'] == "Yes") {
  ...
  <script type="text/javascript">
	...
	window.location.assign("<?php echo base_url(); ?>allowance/login_user")
