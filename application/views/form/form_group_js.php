...
//    if ( $('li.nav-item').hasClass('active') ) {
//        $( 'a.colora' ).addClass( 'active' );
//    $('a.active').css({"background-color": "#21a9e1", "color": "white"});
//  }
$('#locala').css({"background-color": "#21a9e1", "color": "white"});
    });
    //-----------------------------------------
    function chcolor(a1,a2){
	$('#'+a1).css({"background-color": "#21a9e1", "color": "white"});
	$('#'+a2).css({"background-color": "#fff", "color": "#555555"});
	}
    //-----------------------------------------
    function sumqty(){
		var sum = 0;
    ...
    function sumAllowance(x){
		...
		$('#2_sumAll').val(sumAll);
                sumtotallocal(sumAll);
		var sumthai = ThaiBaht(sumAll);
	...
	function sumtotallocal(saumalllocal){
		var saumalloutbound = $('#2_sumAlloutbound').val();
                var totalprice = parseInt(saumalllocal)+parseInt(saumalloutbound);
                $('#1_sumprice').val(totalprice);
	...
	var x = $('#x').val();
		...
		$(document).ready(function() {
			...
			var add_button4     = $(".add_form_field4");
                        ...
                        var wrapperoutbound         = $(".container1outbound");
			var add_buttonoutbound    = $(".add_form_field1outbound");
						...
						'<div class="row">'
							...
							+'<div class="col-md-1">'
								+'<div class="form-group">'
									...
									+'<input class="form-control Allowance totalall'+x+'" name="30[]" id="2_priceA'+x+'" placeholder="ระบุ" required onchange="sumAllowance('+x+')" type="number" min="0"/>'
								+'</div>'
							+'</div>'
							...
							+'<div class="col-md-1">'
								+'<div class="form-group">'
									...
									+'<input class="form-control Accom totalall'+x+'" name="31[]" id="2_priceB'+x+'" placeholder="ระบุ" required onchange="sumAccom('+x+')" type="number" min="0"/>'
								+'</div>'
							+'</div>'
							...
							+'<div class="col-md-1">'
								+'<div class="form-group">'
									...
									+'<input class="form-control Travel totalall'+x+'" name="32[]" id="2_priceC'+x+'" placeholder="ระบุ" required onchange="sumTravel('+x+')" type="number" min="0"/>'
								+'</div>'
							+'</div>'
							...
							+'<div class="col-md-1">'
								+'<div class="form-group">'
									...
									+'<input class="form-control Other totalall'+x+'" name="33[]" id="2_priceD'+x+'" placeholder="ระบุ" required onchange="sumOther('+x+')" type="number" min="0"/>'
								+'</div>'
							+'</div>'
							...
							+'<div class="col-md-2" >'
								+'<div class="form-group">'
									...
									+'<textarea class="form-control autogrow" name="36[]" required id="2_other'+x+'" placeholder="หมายเหตุ" style="height:30.3523px"></textarea>'
								+'</div>'
							+'</div>'
...
//				}
			 ...
			 var deleteint = 'deletea'+x;
				...
				console.log(x);
                        ...
                        $(add_buttonoutbound).click(function(e){
				e.preventDefault();
				//if(x < max_fields){
					x++;
					$(wrapperoutbound).append(
						'<div class="row">'
							+'<div class="col-md-2" style="padding-left:15px;padding-right:15px;">'
								+'<div class="form-group">'
									+'<label class="control-label" for="full_name">ชื่อ</label>'
									+'<input class="form-control" name="28outbound[]" id="2_noutbound'+x+'" placeholder="ระบุ" required />'
								+'</div>'
							+'</div>'
							...
							+'<div class="col-md-2" >'
								+'<div class="form-group">'
									+'<label class="control-label" for="full_name">ตำแหน่ง</label>'
									+'<input class="form-control" name="29outbound[]" id="2_poutbound'+x+'" placeholder="ระบุ" required/>'
								+'</div>'
							+'</div>'
							...
							+'<div class="col-md-1">'
								+'<div class="form-group">'
									+'<label class="control-label" for="full_name">เบี้ยเลี้ยง</label>'
									+'<input class="form-control Allowanceoutbound totalalloutbound'+x+'" name="30outbound[]" id="2_priceAoutbound'+x+'" placeholder="ระบุ" required onchange="sumAllowanceoutbound('+x+')" type="number" min="0"/>'
								+'</div>'
							+'</div>'
							...
							+'<div class="col-md-1">'
								+'<div class="form-group">'
									+'<label class="control-label" for="full_name">ค่าที่พัก</label>'
									+'<input class="form-control Accomoutbound totalalloutbound'+x+'" name="31outbound[]" id="2_priceBoutbound'+x+'" placeholder="ระบุ" required onchange="sumAccomoutbound('+x+')" type="number" min="0"/>'
								+'</div>'
							+'</div>'
							...
							+'<div class="col-md-1">'
								+'<div class="form-group">'
									+'<label class="control-label" for="full_name">ค่าพาหนะ</label>'
									+'<input class="form-control Traveloutbound totalalloutbound'+x+'" name="32outbound[]" id="2_priceCoutbound'+x+'" placeholder="ระบุ" required onchange="sumTraveloutbound('+x+')" type="number" min="0"/>'
								+'</div>'
							+'</div>'
							...
							+'<div class="col-md-1">'
								+'<div class="form-group">'
									+'<label class="control-label" for="full_name">ค่าอื่นๆ</label>'
									+'<input class="form-control Otheroutbound totalalloutbound'+x+'" name="33outbound[]" id="2_priceDoutbound'+x+'" placeholder="ระบุ" required onchange="sumOtheroutbound('+x+')" type="number" min="0"/>'
								+'</div>'
							+'</div>'
							...
							+'<div class="col-md-1" >'
								+'<div class="form-group">'
									+'<label class="control-label" for="full_name">รวม</label>'
									+'<input class="form-control totalallaoutbound'+x+'" name="34outbound[]" id="2_sumoutbound'+x+'" value="" placeholder="ระบุ" required readonly type="number"/>'
								+'</div>'
							+'</div>'
							...
							+'<div class="col-md-2" >'
								+'<div class="form-group">'
									+'<label class="control-label" for="birthdate">หมายเหตุ</label>'
									+'<textarea class="form-control autogrow" name="36outbound[]" required id="2_otheroutbound'+x+'" placeholder="หมายเหตุ" style="height:30.3523px"></textarea>'
								+'</div>'
							+'</div>'

							 +'<div class="col-md-1"  id="deleteaoutbound'+x+'">'
							+'<br>'
							+'<a href="#" class="delete">Delete</a></div>'
                                                        +'</div>'
						+'</div>'
...
//				}
			...
			$(wrapperoutbound).on("click",".delete", function(e){
			 var deleteint = 'deleteaoutbound'+x;
				e.preventDefault(); $('#'+deleteint).parent().remove(); x--;
                                sumAllowanceoutbound();
                                sumAccomoutbound();
                                sumTraveloutbound();
                                sumOtheroutbound();
				console.log(x);
...
//                     setTimeout(function(){ window.location.href = "<?php //echo base_url('Inputform/form_group/')?>"+idsaraban+'/'+user_id; }, 2000);
    ...
    function savedoc_1(){
              ...
              var type_travel1 = $('#type_travel1').val();
                $.ajax({
                    type: 'POST',
                    url: '<?php echo base_url('Inputform/savedoc_1group') ?>',
                    processData: false,
                    contentType: false,
                    data: postData,
                    success: function (data, status) {
...
function upload(){
    ...
    function sumAllowanceoutbound(x){
		
		var sum = 0;
		$(".Allowanceoutbound").each(function(){
			sum += +$(this).val();
		});
		$(".Allowancetotaloutbound").val(sum);
		sumtotalalloutbound(x);
		var sumA = parseInt($('#2_sumAoutbound').val());
		var sumB = parseInt($('#2_sumBoutbound').val());
		var sumC = parseInt($('#2_sumCoutbound').val());
		var sumD = parseInt($('#2_sumDoutbound').val());
		 var sumAll = sumA+sumB+sumC+sumD;

		$('#2_sumAlloutbound').val(sumAll);
                sumtotaloutbound(sumAll);
		var sumthai = ThaiBaht(sumAll);
		$('#2_sumthaioutbound').val(sumthai);    
	}
	////////////////////////////////////////////////////////////////
	
    function sumAccomoutbound(x){
		
		var sum = 0;
		$(".Accomoutbound").each(function(){
			sum += +$(this).val();
		});
		$(".Accomtotaloutbound").val(sum);
		sumtotalalloutbound(x);
		var sumA = parseInt($('#2_sumAoutbound').val());
		var sumB = parseInt($('#2_sumBoutbound').val());
		var sumC = parseInt($('#2_sumCoutbound').val());
    ...
    function sumTraveloutbound(x){
		var sum = 0;
		$(".Traveloutbound").each(function(){
			sum += +$(this).val();
		});
		$(".Traveltotaloutbound").val(sum);
		sumtotalalloutbound(x);
		 var sumA = parseInt($('#2_sumAoutbound').val());
		var sumB = parseInt($('#2_sumBoutbound').val());
		var sumC = parseInt($('#2_sumCoutbound').val());
    ...
    function sumOtheroutbound(x){
		var sum = 0;
		$(".Otheroutbound").each(function(){
			sum += +$(this).val();
		});
		$(".Othertotaloutbound").val(sum);
		sumtotalalloutbound(x);
		var sumA = parseInt($('#2_sumAoutbound').val());
		var sumB = parseInt($('#2_sumBoutbound').val());
		var sumC = parseInt($('#2_sumCoutbound').val());
	...
	function sumtotaloutbound(saumalloutbound){
		var saumalllocal = $('#2_sumAll').val();
                var totalprice = parseInt(saumalllocal)+parseInt(saumalloutbound);
                $('#1_sumprice').val(totalprice);
		
	}
	function sumtotalalloutbound(x){
		var sum1 = 0;
		$(".totalalloutbound"+x).each(function(){
			sum1 += +$(this).val();
		});
		$(".totalallaoutbound"+x).val(sum1);
	}
