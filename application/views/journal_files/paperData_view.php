                        ...
                        <ul class="list-inline menu-left mb-0">
                            ...
                            <li>
                                <div class="page-title-box">
                                    <h4 class="page-title">New Assignments</h4>
                                    <!--<ol class="breadcrumb">
                ...
                <div class="content">
					...
					<div class="card-box table-responsive">	
						<?php if(($this->session->userdata('juserLv') =='1') || ($this->session->userdata('juserLv') =='2')){ ?>
							...
							<tbody>							
							<?php $n=1; $x ='';	$status1 = "'0','1','2','4','5','6'";
								  $status2 =''; $latest =''; $txtpayment =''; $classCH_status ='';
								  $paperData2 = $this->journal_model->list_paperData($x, $status1);
								  ...
								  if($commentNum >0){
									...
									if($commentNum >0){
										foreach($comment->result() as $comment2){}		  
										$status2 = $comment2 ->result_status;
										$latest = ' <span class="badge badge-pink" style="background-color: #F9BC0B">Revised</span>';  
									}  
								  }	
							...
							?>	
								<tr>
                                    ...
                                    <td><?php echo $paperData->title.$latest?>
									<hr style="width: 345px; margin-bottom: -9px; border-color: #c34545; margin-top: 0px; border-width: 0px;"></td>
									...
									<td style="text-align: center">
										...
										<?php if(($paperNum >0) && ($txtpayment == '0')){  $classCH_status = 'CHstatus'; } else if(($paperNum >0) && ($txtpayment == '1')){ $classCH_status = 'CHstatus3'; $paperData->status_process = '1'; } else {  $classCH_status = 'CHstatus'; } ?>	
										
										<a href="#" class="<?php echo $classCH_status;?>" id="s<?php echo $paperData->id?>" data-type="select" data-pk="1" data-value="<?php echo $paperData->status_process;?>" data-title="" ></a> 								
									</td>		
									<td style="text-align: center">
									<?php if(($paperNum >0) && ($txtpayment == '0')){  echo 'In Process'; } else if(($paperNum >0) && ($txtpayment == '1')){  echo 'Confirmed'; } else {  echo 'Waiting'; } ?>				
							 		</td>
									<td><button type="button" class="btn btn-primary waves-effect waves-light btn-sm" onClick="window.location.href = '<?php echo base_url('CMS_Journal/paperDetail/').$paperData->paper_no?>';" >Detail</button></td>					   
							</tr>	
						...
						<table class="table table-bordered table-hover" id="table2">
							...
							<tbody>	
							<?php $n=1;	$status1 = "'1'"; $status2 =''; $latest =''; 
							...
							?>	
								<tr>
									...
									<td style="text-align: center"><button type="button" class="btn btn-primary waves-effect waves-light btn-sm" onClick="window.location.href = '<?php echo base_url('CMS_Journal/paperDetail/').$paperData->paper_no?>';" >Detail</button></td>
									<td style="text-align: center">
