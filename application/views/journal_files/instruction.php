...
<section class="inner-intro bg bg-fixed bg-overlay-black-70" style="background-image:url(<?php echo base_url('journal-html/images/bg/bg-1.jpg')?>);">
  <div class="container">
     <div class="row intro-title text-center">
           <div class="col-sm-12">
				<div class="section-title"><h1 class="title text-white">Instructions for Authors</h1></div>
           </div>
           <div class="col-sm-12">
             <ul class="page-breadcrumb">
                <li><a href="<?php echo base_url('Journal')?>"><i class="fa fa-home"></i> Home</a> <i class="fa fa-angle-double-right"></i></li>
                <li><span>Instructions for Authors</span> </li>
             </ul>
        </div>
     </div>
  </div>
...
<section class="faq-page page-section-ptb"><div class="container"><div class="row">
     <div class="col-sm-12"><div class="section-title text-center">
		<h2 class="title">Instructions for Authors</h2>
     ...
     <div class="col-sm-12"><div class="accordion arrow light-rounded">
             <?php
                                                    $instructionData = $this->journal_model_2->list_instructionData();
                                                    foreach ($instructionData->result() as $instructionData2) { ?>
        <div class="acd-group acd-active"><a href="#" class="acd-heading"><?php echo $instructionData2->topic;?></a>
			<div class="acd-des"> 
			<?php echo $instructionData2->desc;?>	
            </div>
        </div>
                                                    <?php }?>
