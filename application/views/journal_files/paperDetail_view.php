...
<html>
            ...
            <div class="content-page">
				...
				<?php foreach($paperDetail->result() as $paperDetail2){} 
					  ...
					  //foreach($filePaper->result() as $filePaper2){}   
			  		  ...
			  		  $filePaper = $this->journal_model->get_paperFile($paperDetail2->id,$round);
			  		  foreach($filePaper->result() as $filePaper2){}
				?> 	
                       ...
                       <div class="tab-content">
						   ...
						   ?>	
						    <div class="tab-pane" id="messages">
								...
								<br><br>	
								<div class="table-responsive" id="showList"> </div><br><br>					
							  	<p style="text-align: center"><?php if($round >0){ ?><button type="button" class="btn btn-primary waves-light waves-effect" style="background-color: #666666; border: 1px solid #666666; color: #FFFFFF;" onClick="reset2()">Reset</button>
								&nbsp;&nbsp;&nbsp;<?php } ?>	
								<button type="button" class="btn btn-primary waves-light waves-effect" onClick="sendMail_toReviewer()">Send Mail</button></p>				
  ...
  <div class="card">
    ...
    <div class="card-header" id="headingOne">
      <h5 class="mb-0">
        <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">Submission</button>
      </h5>
    </div>
      ...
      <div class="card-body">
		...
		<div class="form-group row" style="background-color: #f5f5f5;">
		  ...
		  <div class="pull-right">
			  <button type="button" class="btn btn-primary waves-effect waves-light btn-sm" onClick="go_reviewers()" >Reviewers</button>
		  </div>
		  <?php } ?>
				...
				<div class="form-group row">
                                   <div class="col-lg-4 col-xl-2">
                                      <div class="file-man-box">
                                         ...
                                         <a href="<?php echo base_url().$editData2->file_pdf?>" class="file-download" target="_blank"><i class="mdi mdi-download"></i> </a>
                                         <div class="file-man-title">
                                              <h5 class="mb-0 text-overflow"><?php echo $this->journal_model->name_paperFile($editData2->file_pdf);?></h5>
                                              <!--<p class="mb-0"><small>568.8 kb</small></p>-->
                                         </div>
                                      </div>
                                   </div>
								   ...
								   <div class="col-lg-4 col-xl-2">
                                      <div class="file-man-box">
                                         ...
                                         <a href="<?php echo base_url().$editData2->file_word?>" class="file-download"><i class="mdi mdi-download"></i> </a>
                                         <div class="file-man-title">
                                              <h5 class="mb-0 text-overflow"><?php echo $this->journal_model->name_paperFile($editData2->file_word);?>	</h5>
                                              <!--<p class="mb-0"><small>568.8 kb</small></p>-->
                                         </div>
                                      </div>
                                   </div>									
        ...
        <div class="form-group row" style="background-color: #f5f5f5;">
                                        <label class="col-md-3 col-sm-12 col-form-label" for="detail_th">Note </label>
                                        <div class="col-md-9 col-sm-12">
                                            <!--<textarea class="form-control" >--><?php echo $editData2->remarks?><!--</textarea>-->
                                        </div>
                                    </div> 
    ...
    <?php } ?>
			...
			<?php } ?>			   
						  <!--<div class="tab-pane" id="settings3">
								<div class="card-box">
								<div class="form-group row">
                                    <label class="col-md-3 col-sm-12 col-form-label" for="detail_th">Review Details </label>
                                    <div class="col-md-9 col-sm-12">
                                        <textarea id="detail_th" name="detail_th" class="ex"></textarea>
                                    </div>
                                </div>
								
								<div class="form-group row">
                                    <label class="col-md-3 col-sm-12 col-form-label" for="detail_th">Upload File </label>
									<div class="col-md-9 col-sm-12">
                                    	<input type="file" class="filestyle" data-btnClass="file_btn">
                                	</div>
                                </div>
					  ...
					  <br><br>
					 <!-- <button class="btn btn-primary"><i class="mdi mdi-plus-circle mr-2"></i> บันทึกข้อมูล</button>	
-->
                    </div> <!-- container -->
				...
				<div id="login-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
					 <div class="modal-dialog">
						...
						<div class="modal-body">
						   <h2 class="text-uppercase text-center m-b-30">Add Editor in Chief</h2>

							 <div class="form-group m-b-25">
								<div class="col-12">
									<label for="name_sname">Name</label>
									<input class="form-control" type="text" id="name_sname" name="name_sname" required="">
								</div>
							 </div>
							
							 <div class="form-group m-b-25">
								<div class="col-12">
									<label for="email">E-mail</label>&nbsp;&nbsp;&nbsp;<label id="ckemail0"></label>
									<input class="form-control" type="email" id="email0" name="email0" required="" onChange="checkEmail(this.value , '0')">
								</div>
							 </div>
							 ...
							 <div class="form-group account-btn text-center m-t-10">
								<div class="col-12">
									<button type="button" class="btn btn-primary" onClick="addEditor('1')"><i class="mdi mdi-plus-circle mr-2"></i> Add</button>
								</div>
							 </div>
						</div>
						</div><!-- /.modal-content -->
				...
				<div id="login-modal2" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
					 <div class="modal-dialog">
						<div class="modal-content">
						<div class="modal-body">
						   <h2 class="text-uppercase text-center m-b-30">Add Reviewer</h2>

							 <div class="form-group m-b-25">
								<div class="col-12">
									<label for="name_sname2">Name</label>
									<input class="form-control" type="text" id="name_sname2" name="name_sname2" required="">
								</div>
							 </div>							
							 
							 <div class="form-group m-b-25">
								<div class="col-12">
									<label for="email2">E-mail</label>&nbsp;&nbsp;&nbsp;<label id="ckemail2"></label>
									<input class="form-control" type="email" id="email2" name="email2" required="" onChange="checkEmail(this.value , '2')">
								</div>
							 </div>	 
							 ...
							 <div class="form-group m-b-25">
								<div class="col-12">
									<label for="password">Password</label>
									<input class="form-control" type="password" id="password2" name="password" required="">
								</div>
							 </div>

							 <div class="form-group account-btn text-center m-t-10">
								<div class="col-12">
									<!--<button class="btn w-lg btn-rounded btn-custom waves-effect waves-light" type="button">เพิ่มข้อมูล</button>-->
									<button type="button" class="btn btn-primary" onClick="addEditor('2')" ><i class="mdi mdi-plus-circle mr-2"></i> Add</button>
								</div>
							 </div>
						</div>
						</div><!-- /.modal-content -->
			...
			if(type =='1'){
			   ...
			   var password = $('#password').val();
				...
				if(name ==''){
					...
					$.post('<?php echo base_url('CMS_Journal/add_Editor')?>' , { name : name , email : email , password : password }, function(data){ 
						if(data ==1){								
							listEditor();
   ...
   /////////////////////////////////
	...
	/////////////////////////////////		
      ...
      /////////////////////////////////
		...
		function sendMail_toEditor(){
			...
			if(editor_id ==''){
				...
				swal({
					title: 'Please select Editor in Chief.',
					//text: "You won't be able to revert this!",
					type: 'warning',								
					confirmButtonClass: 'btn btn-confirm mt-2'
				}) 
	  ...
	  /////////////////////////////////
		...
		function go_reviewers(){		
		 	$('.nav-tabs a[href="#messages"]').tab('show');
		}	
	 //-----------------------------
	 
        function checkEmail(email,num){
			$.post('<?php echo base_url('CMS_Journal/checkemail')?>',{ email : email }, function(data){
				
				if(data >0){  
					$('#ckemail'+num).text('This email is already a member.');
					$('#ckemail'+num).css("color", "red");
					$('#email'+num).val('');
					$('#email'+num).focus();					
					return false;
	 ...
	 //-----------------------------
	 	...
	 	function reset2(){
			$('.checkboxName').removeAttr('checked');
		}
