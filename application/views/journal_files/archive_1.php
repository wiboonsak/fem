     ...
     <div class="row intro-title text-center">
           ...
           <div class="col-sm-12">
             <ul class="page-breadcrumb">
                ...
                <li><a href="<?php echo base_url('Journal/current')?>">Archive</a>  </li>
             </ul>
        </div>
     </div>
  </div>
...
<div class="row row-eq-height"> 
        ...
        <div class="col-md-8 col-sm-12" id="searchID">
            <?php 
            $countAll = $this->journal_model_2->get_archive('-100','-100');
            $countRow = $countAll->num_rows(); 
        $totalRow = ceil($countRow/$perpage);
           foreach ($getarchive->result() as $getarchive2) { ?>
            <div class="post">
                <div class="post-image clearfix"><img alt="" width="550" height="714" src="<?php echo base_url() . 'uploadfile/' . $getarchive2->img ?>" class="img-responsive"></div>
                <div class="post-date"><?php echo $this->journal_model_2->getDay($getarchive2->published_date); ?><span><?php echo $this->journal_model_2->getmonth($getarchive2->published_date); ?></span></div>
                <div class="post-details">
                    <div class="post-title"><h4 class="title" style="font-size: 14pt;"><a href="#"><?php echo $getarchive2->journal_name ?></a></h4></div>
                    <div class="post-content"><p><?php echo $getarchive2->issue ?></p>
                    </div>
                    <a href="<?php echo base_url('Journal/archive_detail/').$getarchive2->id?>" class="button small border animated right-icn"><span>Read More<i aria-hidden="true" class="fa fa-long-arrow-right"></i></span></a>
                    <hr>
                </div>                
            </div>
            <?php }?>
                    <nav class="pagination-nav text-center">
                      <ul class="pagination">
                           <?php 
                                                    ...
                                                    ?>
                        <li class="previous"><a href="<?php echo base_url('Journal/archive/').$page2?> "><span aria-hidden="true">&laquo;</span> Prev</a></li>
                         <?php for($i=1;$i<=$totalRow;$i++){ ?> 
                        <li><a href="<?php echo base_url('Journal/archive/').$i?> " class="pagination__cell no-decoration <?php if($page == $i){ echo 'pagination__cell--active'; }?>"><?php echo $i?></a></li>
                         <?php }?>  
                        <li class="next"><a href="<?php echo base_url('Journal/archive/').$page3?> ">Next <span aria-hidden="true">&raquo;</span></a></li>
                      </ul>
                    </nav> 
