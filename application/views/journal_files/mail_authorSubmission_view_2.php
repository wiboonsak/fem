		  ...
		  <td height="355" align="center" valign="top" bgcolor="#FFFFFF"><p>&nbsp;</p>
			<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
			  <tbody>
				...
				<tr>
				  <td height="81" colspan="3"><br>Your manuscript entitled “<?php echo $paper2->title?>” has been successfully submitted online and is presently being given full consideration for publication in the Journal of Environmental Management and Energy System.<br><br>Your manuscript ID is <?php echo $paper2->paper_no?>.<br><br>Please mention the above manuscript ID in all future correspondence or when calling the office for questions. You can also view the status of your manuscript at any time by checking your Author Center after logging in to <?php echo base_url('submission')?>.<br><br>Thank you for submitting your manuscript to the Journal of Environmental Management and Energy System.<br><br>Sincerely,<br>Journal of Environmental Management and Energy System Editorial Office<br></td>
				</tr>
				<tr>
