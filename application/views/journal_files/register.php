...
$this->db->query($query);
		 ...
		 ?>			   
              ...
              <div class="form-group">
				  ...
				  <div>
				  	<span id="img_captcha"><?php echo $cap['image'];?></span>				  
					<a href="javascript:void(0)" onClick="refresh_captcha()" title="Reload" ><i class="fa fa-refresh" aria-hidden="true" style="margin: 15px; font-size: 22px; color: #333;"></i></a>
  					<input type="text" name="captcha" id="captcha" value="" style="color: #000; width: 240px;" placeholder="Type the characters you see here." onChange="action_captcha(this.value)" />				  
				  </div>
   ...
   <div class="sidebar-widget archives-widget">
      ...
      <?php 
         ...
         <ul class=" list-unstyled list-arrow">
			<?php foreach ($getarchive->result() as $getarchive3) { ?>	 
...
<script>	
	...
	function formRegis(){		
		...
		if(email ==''){					
			...
			alert('Please type the characters you see.');
...
//----------------------
	...
	function refresh_captcha(){	
		...
		$.post('<?php echo base_url('Journal/create_captcha')?>' , { }, function(data){ 
...
//----------------------
	...
	function action_captcha(txt){	
	
		if(txt != ''){
			
			$.post('<?php echo base_url('Journal/action_captcha')?>' , { txt : txt }, function(data){ 
