...
<div class="row row-eq-height">  
        <div class="col-md-8 col-sm-12">
            <div class="post">
                ...
                <div class="post-date">1<span>Jan 19</span></div>
                <div class="post-details">
                    ...
                    <a href="archive_detail.php" class="button small border animated right-icn"><span>Read More<i aria-hidden="true" class="fa fa-long-arrow-right"></i></span></a>
                    <hr>
                </div>                
            </div>
			
			<div class="post">
                <div class="post-image clearfix"><img alt="" src="images/blog/v_02.jpg" class="img-responsive"></div>
                <div class="post-date">31<span>Dec 17</span></div>
                <div class="post-details">
                    <div class="post-title"><h4 class="title" style="font-size: 14pt;"><a href="#">วารสารวิทยาการจัดการ ปีที่ 34 ฉบับที่ 2 กรกฎาคม - ธันวาคม 2560</a></h4></div>
                    <div class="post-content"><p>Vol 34 No 2 (2017)</p>
                    </div>
                    <a href="archive_detail.php" class="button small border animated right-icn"><span>Read More<i aria-hidden="true" class="fa fa-long-arrow-right"></i></span></a>
                    <hr>
                </div>                
            ...
            <div class="post">
                <div class="post-image clearfix"><img alt="" src="images/blog/v_01.jpg" class="img-responsive"></div>
                <div class="post-date">30<span>June 17</span></div>
                <div class="post-details">
                    <div class="post-title"><h4 class="title" style="font-size: 14pt;"><a href="#">วารสารวิทยาการจัดการ ปีที่ 33 ฉบับที่ 1 มกราคม - มิถุนายน 2560</a></h4></div>
                    <div class="post-content"><p>Vol 33 No 1 (2017)</p>
                    </div>
                    <a href="archive_detail.php" class="button small border animated right-icn"><span>Read More<i aria-hidden="true" class="fa fa-long-arrow-right"></i></span></a>
                    <hr>
                </div>                
			...
			<div class="post">
                <div class="post-image clearfix"><img alt="" src="images/blog/v_02.jpg" class="img-responsive"></div>
                <div class="post-date">31<span>Dec 16</span></div>
                <div class="post-details">
                    <div class="post-title"><h4 class="title" style="font-size: 14pt;"><a href="#">วารสารวิทยาการจัดการ ปีที่ 32 ฉบับที่ 2 กรกฎาคม - ธันวาคม 2559</a></h4></div>
                    <div class="post-content"><p>Vol 32 No 2 (2016)</p>
                    </div>
                    <a href="archive_detail.php" class="button small border animated right-icn"><span>Read More<i aria-hidden="true" class="fa fa-long-arrow-right"></i></span></a>
                    <hr>
                </div>                
           ...
           <div class="post">
                <div class="post-image clearfix"><img alt="" src="images/blog/v_01.jpg" class="img-responsive"></div>
                <div class="post-date">30<span>June 16</span></div>
                <div class="post-details">
                    <div class="post-title"><h4 class="title" style="font-size: 14pt;"><a href="#">วารสารวิทยาการจัดการ ปีที่ 31 ฉบับที่ 1 มกราคม - มิถุนายน 2559</a></h4></div>
                    <div class="post-content"><p>Vol 31 No 1 (2016)</p>
                    </div>
                    <a href="archive_detail.php" class="button small border animated right-icn"><span>Read More<i aria-hidden="true" class="fa fa-long-arrow-right"></i></span></a>
                    <hr>
                </div>                
