...
<ul>	<!-- SLIDE  -->
    <li data-index="rs-67" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="revolution/assets/slide4/100x50_ae8a9-1.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
		<!-- MAIN IMAGE -->
        <img src="revolution/assets/slide4/ae8a9-1.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
		<!-- LAYERS -->
		...
		<div class="tp-caption   tp-resizeme" 
            ...
            style="z-index: 5;"><img src="images/slide/journal-new.jpg" alt="" data-ww="auto" data-hh="auto" data-no-retina> </div>
		...
		<div class="tp-caption   tp-resizeme" 
            ...
            style="z-index: 6; white-space: nowrap; font-size: 73px; line-height: 73px; font-weight: 900; color: rgba(53, 53, 53, 1.00);font-family:Roboto;text-transform:uppercase;">Journal </div>
		...
		<div class="tp-caption  text-yellow tp-resizeme" 
            ...
            style="z-index: 7; white-space: nowrap; font-size: 73px; line-height: 40px; font-weight: 900; font-family:Roboto;text-transform:uppercase; font-size: 26pt;">of Environmental Management <br>and Energy System</div>
		...
		<div class="tp-caption   tp-resizeme" 
            ...
            style="z-index: 8; white-space: nowrap; font-size: 17px; line-height: 29px; font-weight: 500; color: rgba(53, 53, 53, 1.00);font-family:Roboto;">Faculty of Environmental Management<br>Prince of Songkla University</div>
		...
		<div class="tp-caption button yellow animated middle-fill" 
            ...
            style="z-index: 13; white-space: nowrap; font-size: 17px; line-height: 29px;outline:none;cursor:pointer;">Details </div>
	</li>
	<!-- SLIDE  -->
...
<section class="page-section-ptb pb-50"><div class="container">
	<div class="row">
    	<div class="col-sm-12 mb-30"><div class="section-title text-center"><h2 class="title">Aims & Scope</h2></div></div>
        <div class="col-sm-6 hidden-xs">
        	<div data-items="1" data-md-items="1" data-sm-items="1">
                <div class="item"><div class="clearfix"><img class="img-responsive" src="images/aim.jpg" alt=""></div></div>
        ...
        <div class="row services clearfix">
    	 <div class="col-sm-12">
         	<p>The JEMES is a journal for the publication of peer reviewed, original research for all aspects of integrated environmental, energy and ecosystem management. The journal scope covers the integration of multidisciplinary sciences for prevention, control, treatment, environmental clean-up and restoration. The study of the existing or emerging problems of environment and ecosystem in the region of Thailand and the creation of novel knowledge and/or recommendations of mitigation measures for sustainable development policies are emphasized.</p>
            <p><strong>Research Areas Include, but are not exclusive to: </strong>
				<ul>
					<li>Resource quality, quantity and sustainability</li>
					<li>Economics of environmental management</li>
					<li>Planning and management of travel and tourism</li>
					<li>Transport and fate of pollutants in the environment </li>
					<li>Spill prevention and management</li>
					<li>Remediation of contaminated sites </li>
					<li>Process modification for pollution prevention</li>
