...
<section class="inner-intro bg bg-fixed bg-overlay-black-70" style="background-image:url(<?php echo base_url('journal-html/images/bg/bg-3.jpg')?>);">
  <div class="container">
     <div class="row intro-title text-center">
           <div class="col-sm-12">
				<div class="section-title"><h1 class="title text-white">About JEMES</h1></div>
           </div>
           <div class="col-sm-12">
             <ul class="page-breadcrumb">
                <li><a href="<?php echo base_url('Journal')?>"><i class="fa fa-home"></i> Home</a> <i class="fa fa-angle-double-right"></i></li>
                <li><span>About JEMES</span> </li>
             </ul>
        </div>
     </div>
  </div>
...
<section class="faq-page page-section-ptb"><div class="container"><div class="row">
     <div class="col-sm-12"><div class="section-title text-center">
		<h2 class="title">About JEMES</h2>
		<p>Journal of Environmental Management and Energy System (JEMES)</p>
     </div></div>
     
     <div class="col-sm-12"><div class="accordion arrow light-rounded">             
	<?php	$aboutData = $this->journal_model_2->list_aboutData();
            foreach($aboutData->result() as $aboutData2){ ?>                                                 
                                                       
        <div class="acd-group "><a href="#" class="acd-heading"><?php echo $aboutData2->topic;?></a>
			<div class="acd-des"><p><?php echo $aboutData2->desc;?></p></div>
        </div>
   <?php } ?>       
