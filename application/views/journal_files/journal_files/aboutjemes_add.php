                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="card m-b-30 card-body">
                                               ...
                                               <!-- <div class="row">-->
                                                    <?php  if($currentID != ''){
                                                        		$aboutData = $this->journal_model_2->list_aboutData($currentID);
                                                        		foreach ($aboutData->result() as $aboutData2){ }
                                                    } ?>   
                                                    <form enctype="multipart/form-data" id="aboutForm" name="aboutForm">
                                                        <div class="form-group row">
                                                            <label class="col-md-3 col-sm-12 col-form-label">Topic</label>
                                                            <div class="col-md-9 col-sm-12">
                                                                <input id="topic" name="topic" type="text" class="form-control form-control-sm" value="<?php if($currentID != ''){ echo $aboutData2->topic; } ?>" >
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-md-3 col-sm-12 col-form-label">Detail</label>
                                                            <div class="col-md-9 col-sm-12">
                                                                <textarea id="desc" name="desc" type="text" class="ex" ><?php if($currentID != ''){  echo $aboutData2->desc; }?></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row" >
