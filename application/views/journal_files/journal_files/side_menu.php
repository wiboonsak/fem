...
//echo 'e...'.$countPaperA2; echo 'r...'.$countPaperE2;
       // $countPaper = $this->journal_model->list_paperData($userID, $status1);
...
<?php if(($this->session->userdata('juserLv') =='1') || ($this->session->userdata('juserLv') =='2')){ ?>
	...
	<?php } ?>			
                <li>
                    <a href="<?php echo base_url('CMS_Journal')?>">
                        <i class="fi-air-play"></i><span class="badge badge-danger badge-pill pull-right" style="background-color: #F9BC0B;"><?php echo $countPaper2 ?></span> <span> New Assignments </span>
                    </a>
                </li>  
