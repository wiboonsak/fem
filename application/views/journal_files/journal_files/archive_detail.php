...
<section class="inner-intro bg bg-fixed bg-overlay-black-70" style="background-image:url(<?php echo base_url('journal-html/images/bg/bg-1.jpg')?>)">
  <div class="container">
      <?php 
           foreach ($aechive_datail->result() as $aechive_datail2) {} ?>
     <div class="row intro-title text-center">
           ...
           <div class="col-sm-12">
             <ul class="page-breadcrumb">
                ...
                <li><a href="<?php echo base_url('Journal/archive')?>">Archive</a> <i class="fa fa-angle-double-right"></i></li>
                <li><span><?php echo $aechive_datail2->journal_name ?>  <?php echo $aechive_datail2->issue ?></span> </li>
             </ul>
        </div>
     </div>
  </div>
     ...
     <?php 
        ...
        <div class="col-md-8 col-sm-12" id="searchID">
            <div class="post" style="padding-bottom: 20px;">
                <div class="post-image clearfix"><img alt="" width="550" height="714" src="<?php echo base_url() . 'uploadfile/' . $aechive_datail2->img ?>" alt="image" /></div>
                <div class="post-date"><?php echo $this->journal_model_2->getDay($aechive_datail2->published_date); ?><span><?php echo $this->journal_model_2->getmonth($aechive_datail2->published_date); ?></span></div>
                <div class="post-details">
                    <div class="post-title"><h4 class="title" style="font-size: 14pt;"><a href="#"><?php echo $aechive_datail2->journal_name ?> </a></h4></div>

                    <div class="post-content"><p><?php echo $aechive_datail2->issue ?></p>
                    </div>
                </div>
            </div><hr>                    
              <?php $getsection = $this->journal_model_2->get_listSection($aechive_datail2->id);
                    foreach($getsection->result() as $getsection2){ 
						
						$PDFview = $this->journal_model_2->get_listPDF($aechive_datail2->id,$getsection2->id);
