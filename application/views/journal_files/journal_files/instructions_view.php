                                                            ...
                                                            <tbody>	
                                                                ...
                                                                foreach($instructionData->result() as $instructionData2){ ?>
                                                                    <tr>
                                                                        ...
                                                                        <td><?php echo $instructionData2->topic?></td>					<td><?php echo $this->journal_model_2->getIncluded($instructionData2->date_add); ?></td>
                                                                        <td align="center">
                                                                            <label><input id="ch<?php echo $instructionData2->id?>" type="checkbox" class="js-switch js-check-change" onClick="setShow_onWeb('<?php echo $instructionData2->id?>', this.value, 'tbl_journal_instruction')" value="<?php echo $instructionData2->show_onweb?>" <?php if($instructionData2->show_onweb == '1'){ echo 'checked'; }?> data-plugin="switchery" data-color="#007bff" data-size="small"/></label>
                                                                        </td>
                                                                        <td><button type="button" class="btn btn-success btn-sm" onClick="window.location.href='<?php echo base_url('CMS_Journal/instructions_add/').$instructionData2->id?>'" >Edit</button></td>
                                                                        <td><button type="button" class="btn btn-danger btn-sm" onClick="delete_data('<?php echo $instructionData2->id?>', 'tbl_journal_instruction')">Delete</button></td>
                                                                    </tr>
    <?php $n++; } ?>
                                                            </tbody>
                                                        </table>
