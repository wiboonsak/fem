...
//						var api_link = "<?php //echo base_url(); ?>saraban/update_chk_doc"; 
...
//															closeOnConfirm: false,
//														}, function () { 
//															window.location.href = '<?php //echo base_url(); ?>Saraban/chkstatus_admin';
//														});  
//												}else{ 
...
//														closeOnConfirm: false,
//													}, function () {
//													window.location.href = '<?php //echo base_url(); ?>Saraban/fail_admin'; 
//													});  
//												}else{ 
//													swal("ไม่สามารถทำรายการได้", "กรุณาตรวจสอบรายการใหม่อีกครั้ง", "error");
//												}
...
//		} 
    ...
    function sendpass(dataid,p_or_f,textpass){
        swal({
					title: "ยืนยันการตรวจเช็คให้ "+"'"+textpass+"'",
					text: "ระบบจะทำการเพิ่มเลขสารบรรณให้อัตโนมัติ",
					type: "warning",
					showCancelButton: true, 
					confirmButtonClass: "btn-danger", 
				...
				function(){
                                    var sendto = $('#sendto').val();
                                    var command = $('#command').val();
                                     $.post('<?php echo base_url('Saraban/update_chk_doc') ?>', {dataid: dataid, p_or_f: p_or_f, sendto:sendto, command:command},
                    function (data) {
                        if(data==1){
                              swal({
                        ...
                        setTimeout(function () {
                            window.location.href = "<?php echo base_url('Saraban/index_admin') ?>";
                        }, 2000);
                        }else{
