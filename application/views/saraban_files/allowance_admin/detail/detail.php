...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tbody>
    <tr>
      ...
      <td width="95%" height="30" align="left" valign="bottom"><input type="text" name="textfield2" id="textfield2" value="ขออนุมัติเดินทางไปปฏิบัติงาน ณ ต่างประเทศ" disabled class="input-data" style="width: 100%;"></td>
    </tr>
    <!--<tr>
      <td height="5"></td>
      <td height="5" style="border-top: 1px dotted #000000;"></td>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tbody>
    <tr>
      <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ด้วยคณะการจัดการสิ่งแวดล้อม&nbsp;เสนอขออนุญาตให้&nbsp;<input type="text" name="textfield7" id="textfield5" value="พนักงานมหาวิทยาลัยและพนักงานเงินรายได้" disabled class="input-data" style="width: 65%;">&nbsp;จำนวน <input type="text" name="textfield8" id="textfield7" value="3" disabled class="input-data" style="width: 10%;"> ราย เดินทางไป&nbsp;เข้าร่วมประชุม&nbsp;&nbsp;เรื่อง <input type="text" name="textfield" id="textfield" value="การปฎิบัติงานด้านเทคโนโลยีและภูมิสารสนเทศ" disabled class="input-data" style="width: 880px;"> ณ&nbsp;<input type="text" name="textfield" id="textfield" value="Feng Chia University ประเทศไต้หวัน" disabled class="input-data" style="width: 75%;">&nbsp;ตั้งแต่วันที่&nbsp;11 มีนาคม 2562&nbsp;ถึง&nbsp;20 มีนาคม 2562 โดยใช้เงินสนับสนุนจาก&nbsp;<input type="text" name="textfield6" id="textfield16" value="รายได้คณะ" disabled class="input-data" style="width: 55%;">&nbsp;ซึ่งมีรายนามดังต่อไปนี้<br><br>		  
		...
		<?php if($career_id == '4'){ ?>	  
            ...
            <tr>
              ...
              <td width="450" align="left"><input type="text" name="textfield5" id="textfield6" value="นายนพรัตน บำรุงรักษ์" class="input-data" style="width: 400px;" disabled></td>
              <td width="350" align="left">ตำแหน่ง
                <select disabled name="select" class="input-data">
              ...
              <td width="241" align="left">ตำแหน่งเลขที่
                <input type="text" name="textfield4" id="textfield4" value="0006" disabled class="input-data" style="width: 100px;"></td>
            </tr>
            <tr>
              <td align="right">&nbsp;</td>
              <td align="left">&nbsp;</td>
            ...
            <tr>
              <td align="right">2.&nbsp;</td>
              <td align="left"><input type="text" name="textfield9" id="textfield8"disabled value="นางสาวนริสรา นุธรรมโชติ" class="input-data" style="width: 400px;"></td>
              <td align="left">ตำแหน่ง
                <select name="select2" class="input-data" disabled>
              ...
              <td align="left">ตำแหน่งเลขที่
                <input type="text" name="textfield9" id="textfield9" value="2547" disabled class="input-data" style="width: 100px;"></td>
            </tr>
            <tr>
              <td align="right">3.&nbsp;</td>
              <td align="left"><input type="text" name="textfield9" id="textfield10" value=" นายคัมภีร พวงทอง" disabled class="input-data" style="width: 400px;"></td>
              <td align="left">ตำแหน่ง
                <select name="select2" class="input-data" disabled>
                  <option value="" selected>อาจารย์</option>
                  <option value="">รองศาสตราจารย์</option>
              ...
              <td align="left">ตำแหน่งเลขที่
                <input type="text" name="textfield9" id="textfield11" value="3236" disabled class="input-data" style="width: 100px;"></td>
            </tr>
		<?php } ?>	  
            <!--<tr>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tbody>
    ...
    <tr>
      ...
      <td height="30" align="center" valign="bottom"><input type="text" value="รองศาสตราจารย์ ดร.นพรัตน บำรุงรักษ์" disabled class="input-data" style="width: 263px;"><!--(นายวรดร ไผ่เรือง)--></td>
    </tr>
    <tr>
      <td width="600">&nbsp;</td>
      <td height="30" align="center">&nbsp;</td>
