...
if(in_array($userDetail2->career_id, $array1)){	
	...
	$html = $html.'<tr>
      <td style="text-align: justify;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;จึงเรียนมาเพื่อโปรดพิจารณาอนุมัติ';
			...
			foreach($withdrawData->result() as $withdrawData2){	
				...
				if($withdrawData2->allowance1_baht != '0.00'){
					...
					<tr>
					  ...
					  <td width="163" align="left" colspan="2">ค่าเบี้ยเลี้ยง</td>
				...
				if($withdrawData2->accommodation1_baht != '0.00'){
					...
					<tr>
					  <td width="90" align="right">'.$num_withdraw.'.&nbsp;&nbsp;</td>
					  <td width="163" align="left" colspan="2">ค่าที่พัก</td>
...
//if(($this->session->userdata['logged_in']['status'] != 'admin_saraban') && ($documentData2->approve_id != $this->session->userdata['logged_in']['id'])){
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tbody>
	...
	if(($documentData2->reason_request == '1') && ($documentData2->withdraw == '1')){		  
	  ...
	  $html2 = $html2.'ดังเอกสารที่แนบมาพร้อมนี้</td>
    </tr>';		
...
if(in_array($userDetail2->career_id, $array1)){
	...
	$html2 = $html2.'	
    <tr>
      <td style="text-align: justify;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id="doCH">จึงเรียนมาเพื่อโปรดพิจารณาอนุมัติ';
