...
$default_showPDF = '1';
if(($documentData2->approve_id == $this->session->userdata['logged_in']['id']) && ($documentData2->approve_id2 != $this->session->userdata['logged_in']['id']) && ($this->session->userdata['logged_in']['status'] == 'user')){
	$default_showPDF = '0';
}

if(($this->session->userdata['logged_in']['status'] != 'admin_saraban') && ($default_showPDF == '1')){
	
	if($documentData2->saraban_number != ''){
		
		$saraban_number2 = $this->Saraban_model->explode_sarabanNumber($documentData2->saraban_number,'1');
		
	} else if($documentData2->saraban_number == ''){
		
		$saraban_number2 = 'มอ 820/';
	}
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tbody>
    <tr>
	  <td width="5%" align="left" valign="bottom"><span style="font-size: 20pt"><strong>ที่</strong></span></td>
      <td width="44%" align="left" valign="bottom" style="border-bottom: 0px dotted #000000;">&nbsp;&nbsp;'.$saraban_number2.'</td>
	  <td width="7%" align="left" valign="bottom">&nbsp;<span style="font-size: 20pt"><strong>วันที่</strong></span></td>
      <td width="44%" align="left" valign="bottom" style="border-bottom: 0px dotted #000000;">&nbsp;&nbsp;&nbsp;'.DateThai($documentData2->date_create).'</td>
    </tr>
    <!--<tr>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tbody>
    <tr>
      <td width="7%" align="left" valign="bottom"><span style="font-size: 20pt"><strong>เรื่อง</strong></span></td>
      <td width="93%" align="left" valign="bottom" style="border-bottom: 0px dotted #000000;">&nbsp;&nbsp;'.$subject_doc2.'</td>
    </tr>
    <!--<tr>
      <td height="5"></td>
      <td height="5" style="border-top: 1px dotted #000000;"></td>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tbody>
    <tr>
      <td style="text-align: justify; word-spacing:-2px; text-justify: distribute;" > <span style="color:#fff;">xxxxxxxxxxxx</span>ด้วยคณะการจัดการสิ่งแวดล้อม เสนอขออนุญาตให้'.$documentData2->group_name.' จำนวน '.$documentData2->number_people.' ราย เดินทางไป'.$travel_for.' เรื่อง '.$documentData2->subject_form.' ณ '.$documentData2->place.' ตั้งแต่วันที่ '.$txt_date.' โดยใช้เงินสนับสนุนจาก'.$documentData2->money_source.$txtbaht;
	...
	$html2 = $html2.'ซึ่งมีรายนามดังต่อไปนี้<br>	  
...
if(($documentData2->approve_id2 != 0) && (in_array($userDetail2->career_id, $array1))){	
	
	$approveName = $this->Allowance_model->get_userDetail($documentData2->approve_id2);
	foreach($approveName->result() as $approveName2){}
...
if(($documentData2->approve_id2 != 0) && (in_array($userDetail2->career_id, $array2))){
	...
	$html2 = $html2.'<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
  <tbody>';
  
  if($documentData2->approve_status2 == '1'){
