...
$pdf->SetTitle('ขออนุมัติเดินทางในประเทศ (สำหรับคณะเดินทาง)');
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tbody>
    <tr>
      <td style="text-align: justify; word-spacing:-2px; text-justify: distribute;" > <span style="color:#fff;">xxxxxxxxxxxx</span>ด้วยคณะการจัดการสิ่งแวดล้อม เสนออนุมติให้'.$documentData2->group_name.' จำนวน '.$documentData2->number_people.' ราย เดินทางไป'.$travel_for.' เรื่อง '.$documentData2->subject_form.' ณ '.$documentData2->place.' '.$txt_vacation.' ตั้งแต่วันที่ '.$txt_date.' โดยใช้เงินสนับสนุนจาก'.$documentData2->money_source.$txtbaht;
...
if($documentData2->approve_id != 0){	
  ...
  <tbody>
    <tr>';
     ...
     $html2 = $html2.' <td width="40%" align="left" style="border: 1px solid black;font-size:16px ">
...
//                }
//	
//	$html2 = $html2.'<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
//  <tbody>
//    <tr>
