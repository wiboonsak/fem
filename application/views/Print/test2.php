...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tbody>
    <tr>
      <td style="text-align: justify;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ด้วย '.$userDetail2->titlename.$userDetail2->firstname.' '.$userDetail2->lastname.' '.$careerData2->career.'&nbsp; ตำแหน่ง'.$positionData2->position.'&nbsp; ตำแหน่งเลขที่ '.$userDetail2->position_number.$wage.'สังกัดคณะการจัดการสิ่งแวดล้อมมีความประสงค์จะเดินทางไปปฎิบัติงานเพื่อเข้าร่วมประชุม &nbsp;เรื่อง The 6th International Conference on Social Sciences and Business&nbsp;ณ&nbsp;ประเทศญี่ปุ่น มีกำหนด&nbsp;7&nbsp;วัน&nbsp;ตั้งแต่วันที่&nbsp;23 มิถุนายน&nbsp;ถึงวันที่&nbsp;30 มิถุนายน 2561 โดยใช้เงินสนับสนุนจาก&nbsp;Ernst Mach Grant - ASEA-UNINET&nbsp;ดังเอกสารที่แนบมาพร้อมนี้</td>
    </tr>
    <tr>
      <td height="30">&nbsp;</td>
    </tr>';
...
if($career_id == '5'){
	...
	$html = $html.'	
    <tr>
      <td style="text-align: justify;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;จึงเรียนมาเพื่อโปรดพิจารณาอนุมัติ&nbsp;และลงนามในหนังสือถึงปลัดกระทรวงการต่างประเทศ แจ้งงาน ทะเบียนประวัติ&nbsp;และต้นฉบับคืนหน่วยงาน</td>
    </tr>
</tbody>
</table>'; 
}	
