...
if($documentData2->approve_id != 0) {
  ...
  <tbody>
    <tr>';
     ...
     $html = $html.' <td width="40%" align="" style="border: 1px solid black;font-size:16px ">
...
//       }
//	
//	$html = $html.'	<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0"><tbody>';
//  
