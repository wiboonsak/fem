...
<!---------------------------------------------------------------------------->
				...
				<?php //if($this->session->userdata['logged_in']['status'] != 'approve'){ ?>						
							<div class="form-group">
								...
								<?php /*if(($this->session->userdata['logged_in']['status'] == 'user') && ($documentData2->approve_id != $this->session->userdata['logged_in']['id']) && ($documentData2->approve_id2 != $this->session->userdata['logged_in']['id']) && (($documentData2->check_doc2 == '3') || ($documentData2->check_doc2 == '0')) && ($documentData2->check_doc == '1') && ($documentData2->approve_status != '')){ ?>
