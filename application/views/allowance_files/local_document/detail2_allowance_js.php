...
<?php if(($documentData2->check_doc != '3') && ($documentData2->check_doc != '0') && ($checkURI != 'localGroup_withdraw') && ($checkURI != 'localGroup')){ ?>
<script>
  ...
  $('#textchange').val('1');
	...
	function add_listName2(){ //console.log('......');	
		...
		if(career_val != ''){  //console.log('career_val...'+career_val);	
			...
			if($('tr').hasClass(txtClass)){
				...
				//var html_first = '<tr class=""><td align="left" colspan="2" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>'+career+'</strong></td><td align="left">&nbsp;</td><td align="left">&nbsp;</td></tr>';
	...
	function check_vacation(check){	
		...
		if(check == true){
			...
			$.ajax({
				type:'POST',
				url:'<?php echo base_url('Allowance2/modal_listNamelocal')?>',
				processData: false,
				contentType: false,
				data : postData,
	...
	function saveData(){
		...
		if(file1 ==''){				
			...
			if(document_id == ''){
				...
				var fnName = 'saveData_outboundlocal';
			   
			} else {
				   
				var fnName = 'editData_outboundlocal/'+document_id;				   
			}
				...
				success:function(data){
					...
					if(id != 'x'){						
						...
						if(document_id == ''){	
							...
							var url3 = '<?php echo base_url();?>Allowance2/detailLocal/'+withdraw+'/'+for_type+'/'+id;
