...
//                                },
//                               function () {
                                       var api_link = "<?php echo base_url(); ?>allowance/get_report_Budget_admin"; 
...
//                                                    function(){
                                                      ...
                                                      for (var i = 0; i < info['allow'].length; i++) {
                                                      	x=x+1;
                                                      	var id_allow = "";
                                                        var total = parseInt(info['allow'][i].new_allowance1_total)+parseInt(info['allow'][i].new_allowance2_total)+parseInt(info['allow'][i].new_accommodation1_total)+parseInt(info['allow'][i].new_accommodation2_total)+parseInt(info['allow'][i].new_passage_baht)+parseInt(info['allow'][i].new_other_baht);
