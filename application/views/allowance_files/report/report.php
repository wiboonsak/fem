	...
	<div class="main-content">
		...
		<h2 style="text-align: center; padding-top: 20px;">รายงานคำขอเดินทางต่างประเทศ</h2>
		<div class="row">
					...
					<div class="panel-body">
						<form role="form" class="form-horizontal form-groups-bordered" >
							...
							<div class="form-group">
								...
								<div class="col-sm-2">
									<select  id="checkdoc" style="font-size: 14px">
										<option value="null">เลือก</option>	
								...
								<div class="col-sm-3">
									<select  id="approve" style="font-size: 14px">
										<option value="null">เลือก</option>	
							...
							<div  class="form-group">
								...
								<div class="col-sm-3">
									<select class="form-control" id="id_saraban" style="font-size: 16px">
										...
										<?php foreach ($getdata as $getdata1): 
											if($getdata1['id_saraban'] != null){
										?>
										<option value = "<?php echo $getdata1['id_saraban']; ?>"><?php echo $getdata1['id_saraban']; ?></option>;			
										<?php 
										}
										endforeach; 
										?>
								...
								<div class="col-sm-3">
									<select class="form-control" id="topic" style="font-size: 16px">
										...
										?>
										<option value = "<?php echo $getdata2['topic']; ?>"><?php echo $getdata2['topic']; ?></option>;			
										<?php 
										}
										endforeach; 
										?>
