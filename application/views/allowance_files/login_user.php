...
<div class="login-container">
	...
	<div class="login-header login-caret" style="background-color: #1c3b69 !important">
		...
		<div class="login-content">
			...
			<p class="description" style="color: white; font-size: 20px">Allowance User Login</p>
	...
	<div class="login-form">
		...
		<div class="login-content">
			...
			<div class="login-bottom-links">
				...
				<a href="<?php echo base_url('allowance/register'); ?>" class="link" >Register</a><br/>
				<a href="<?php echo base_url('allowance/forgotpassword'); ?>" class="link">Forgot your password?</a><br/>
				<a href="<?php echo base_url('allowance/login_admin'); ?>" class="link">Administrator Login</a>
<!--				<br />
				<a href="<?php echo base_url('allowance/login_approve'); ?>" class="link">Approve Login</a>-->
				<br /><br />
	...
	<script src="<?php echo base_url('assets_saraban/js/neon-login.js'); ?>"></script>
