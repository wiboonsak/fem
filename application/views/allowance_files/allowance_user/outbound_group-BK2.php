		...
		<?php //if($career_id == '5'){ $url3 = 'Printer_controller/PreviewGroup2'; } ?>	  
			...
			<tr class="career_tr2">
              <td align="left" colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--<strong>ข้าราชการ</strong>--><select name="select_career" id="select_career" class="input-data"><!--onChange="tr_career(this.value)"-->
				...
				<button type="button" class="btn btn-blue btn-sm" onClick="add_listName()">เพิ่มข้อมูล</button>  
            ...
            <tr class="trNamePerson position_tr">
              ...
              <td width="450" align="left">
				  ...
				  <input type="text" name="name[]" id="name" placeholder="ระบุชื่อผู้เดินทาง" class="input-data" style="width: 400px;">
				  
				  <input type="hidden" name="career_id[]" id="career_id0" value="" >
              ...
              <td width="241" align="left">ตำแหน่งเลขที่
                <input type="text" name="position_number[]" id="position_number" placeholder="ระบุตำแหน่งเลขที่" class="input-data" style="width: 120px;"></td>
            </tr>
			<tr class="tdheight">
      			<td height="30">&nbsp;</td>
    		</tr>  
...
<?php } ?>
	...
	<tr>
      <td>
		  <div class="checkbox" style="margin-left: 7%;"><label><input type="checkbox" id="CHvacation" name="CHvacation" onClick="check_vacation(this.checked)" value="0" >ต้องการลาพักผ่อน</label></div>
	  </td>
    </tr>
