	...
	<div class="main-content">	
		<h2 style="text-align: center; padding-top: 20px;">รายการคำขอเดินทาง</h2>
		<br>
		<br>
				...
				if (is_array($getdata) || is_object($getdata))
				{
					...
					<tr class="gradeA odd" role="row">
						...
						<td class="center">
							...
							?>					
								<a href="edit2_allowance?id_allowance=<?php echo $getdata['id_allowance']; ?>" class="btn btn-default btn-sm btn-icon icon-left">
							...
							?>
								<a href="<?php echo base_url() ?>Allowance/view2_allowance?id_allowance=<?php echo $getdata['id_allowance']; ?>" class="btn btn-info btn-sm btn-icon icon-left">
