<div class="main-content">
		...
		<h2 style="text-align: center; padding-top: 20px;">ข้อมูลผู้อนุมัติ</h2>
		<br />
		<br />
					...
					<?php $num = 0; foreach($getApprovers as $getApprovers) : $num++; ?> 
						<script type="text/javascript">
							var dataObj = {
											...
											usrname 	: "<?php echo $getApprovers['user_name']; ?>", 
						...
						<tr class="odd gradeX">
							...
							<td class="center">
								<a href="<?php echo base_url();?>Allowance/add_approvers/<?php echo $getApprovers['id'];?>" class="btn btn-default btn-sm btn-icon icon-left">
								...
								<!--<a onclick="edituserpass('<?php //echo $getApprovers['id']; ?>')" class="btn btn-orange btn-sm btn-icon icon-left">
