					...
					<div class="panel-body">
						...
						<?php } ?>
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input readonly   type="number" class="form-control" id="field-0" value="<?php echo $getdataAllow['id_saraban']; ?>">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input readonly type="text" class="form-control" id="field-1" value="<?php echo $getdataAllow['topic']; ?>">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input readonly type="date" class="form-control" id="field-4" value="<?php echo $getdataAllow['date_add']; ?>" >
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input readonly type="text" class="form-control" id="field-3"  value="<?php echo $getdataAllow['text1']; ?>" >
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<!--<div class="form-group">-->
										<textarea readonly class="form-control" style="margin: 0px; width: 100%; height: 200px;" name="detail_1" id="detail_1"><?php echo trim($getdataAllow['text2']); ?>
										</textarea>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">									
										<textarea readonly class="form-control" style="margin: 0px; width: 100%; height: 200px;" name="detail_2" id="detail_2">
											<?php echo trim($getdataAllow['text3']); ?>
										</textarea>
								...
								<div class="col-sm-9">
									<input readonly type="text" class="form-control" id="field-5" value="<?php echo $getdataAllow['footer']; ?>">
							...
							<?php if($getdataAllow['text6'] == '1' || $getdataAllow['text6'] == '2' || $getdataAllow['text6'] == '3'){ ?>	
								...
								<?php }else if($getdataAllow['text6'] == '3'){?>
										...
										<label>อื่นๆ</label>
										<input readonly type="text" id="field-6" class="form-control" name="field-6" value="<?php echo $getdataAllow['budget_datail'];?>" >
									</div>
								<?php } ?>
								...
								<div class="col-sm-9">	
									<span id='alert_error'></span>							 
								 	<p class="bs-example"> 
								 		...
								 		<button type="button" class="btn btn-red btn-icon" onclick="window.location.href ='<?php echo base_url(); ?>Allowance/index_approve6';">ปิด<i class="entypo-cancel"></i> </button> 
