					...
					<div class="panel-body">
						...
						<?php foreach($getdataAllow as $getdataAllow) { ?> 
							...
							<script type="text/javascript">
								...
								budget  	 = "<?php echo $getdataAllow['text6']; ?>";
								id_saraban 	 = "<?php echo $getdataAllow['id_saraban']; ?>";
								topic        = "<?php echo $getdataAllow['topic']; ?>";
								user_create	 = "<?php echo $getdataAllow['user_create']; ?>";
							</script> 
						...
						<form role="form" class="form-horizontal form-groups-bordered" >
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input readonly style="font-size: 16px" type="text" class="form-control" id="field-00" value="<?php echo $getdataAllow['ref_saraban']; ?>" onkeyup="	$('#field-00_error').html('').css('color', 'red');">
						...
						<?php } ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
										<label>อื่นๆ</label>
										<input readonly style="font-size: 16px" type="text" id="field-6" class="form-control" name="field-6" value="<?php echo $getdataAllow['budget_datail'] ?>" >							
								</div>
							</div>
							<?php } else if($getdataAllow['text6'] == '0'){?>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">	
									<span id='alert_error'></span>							 
								 	<p class="bs-example"> 
								 		<button type="button" class="btn btn-success btn-icon" onclick="dusubmit_approve()">อนุมัติ<i class="entypo-mail" ></i> </button>  
