...
<!--	<h2 style="text-align: center; ">ระบบเบิกค่าเดินทาง</h2>
	...
	<br />
		...
		<h2 style="text-align: center; padding-top: 20px;">รายการคำขอเดินทาง ไม่อนุมัติ</h2>
		<br />
		<br />
		<table class="table table-bordered datatable" id="table-1">
			...
			<tbody>
				...
				<tr class="odd gradeX">
					...
					<td class="center">
						<button type="button" onclick="location.href='<?php echo base_url() ?>Allowance/view_approve_3/<?php echo $getdataPending['id_allowance']; ?>'" class="btn btn-info btn-sm btn-icon icon-left"> 
