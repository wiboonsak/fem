								...
								<div class="col-sm-9">	
									<span id='alert_error'></span>							 
								 	<p class="bs-example"> 
								 		...
								 		<button type="button" class="btn btn-red btn-icon" onclick="window.location.href ='<?php echo base_url(); ?>Allowance/index_approve2';">ปิด<i class="entypo-cancel"></i> </button> 
