						...
						<script type="text/javascript">
 						...
 						<form role="form" class="form-horizontal form-groups-bordered">
							...
							<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										...
										<input readonly type="text" style="font-size: 16px" class="form-control" id="field-0" value="<?php echo $getdataAllow['topic']; ?>" >
									</div>
								</div> 
							...
							<div class="form-group">
								...
								<div class="col-sm-9">									
										<textarea readonly class="form-control" style="margin: 0px; width: 100%; height: 200px; font-size: 16px" name="detail_2" id="detail_2">
											<?php echo trim($getdataAllow['text3']); ?></textarea>
