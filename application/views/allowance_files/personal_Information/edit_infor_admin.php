					...
					<div class="panel-body">
					  ...
					  <form role="form" class="form-horizontal form-groups-bordered" >
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input type="text" class="form-control" onchange="chk_email()" name="email" id="email" data-mask="email" placeholder="E-mail" autocomplete="off" value="<?php echo $getdata ->email;?>"  />
						...
						<div class="form-group">
							<label for="field-1" class="col-sm-3 control-label">ชื่อ - นามสกุล</label>
                                                        <div class="col-sm-2">
								<input type="text" class="form-control" name="titlename" id="titlename" placeholder="Title Name" autocomplete="off" value="<?php echo $getdata ->titlename;?>"/>
							...
							<div class="col-sm-5">
                                   <select id="position" name="position"  class="form-control form-control-sm" >
										...
										<option value="<?php echo $posData2->id ?>" <?php if (($getdata ->position_id == $posData2->id)) { echo 'selected';}?> >
