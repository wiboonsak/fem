...
<!--                        <span id='email_error'></span>-->
                                                             <a  id="bt1"class="btn btn-primary btn-sm" onclick="ADDemail()">เพิ่มช่องสำหรับระบุอีเมล์</a>
                                                             <br>
                    </div>
						 ...
						 <div class="form-group ">
                                                    ...
                                                    if ($currentID != '') { 
                                                     ...
                                                     <div class="form-group">
                                                         ...
                                                         <div   class="col-sm-5">
                                                         <input type="text" id="email<?php echo $email2->id?>" name="email" value="<?php  echo $email2->email;?>" class="form-control form-control-sm" readonly>
                                                          </div> 
