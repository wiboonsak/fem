   ...
   <html lang="en" class="no-js"> <!--<![endif]-->
	...
	<div id="fb-root"></div>
        ...
        <div id="wrapper" class="main-wrapper">
            ...
            <div class="container">
                <h2 class="page-title"><?php if($this->session->userdata('weblang') == 'en'){ echo 'News'; } else { echo 'ข่าวประชาสัมพันธ์'; }?></h2>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-offset-1  col-md-10 text-center">
                                <h1><?php if($this->session->userdata('weblang') == 'en'){ echo 'News'; } else { echo 'ข่าวประชาสัมพันธ์ คณะการจัดการสิ่งแวดล้อม'; }?></h1>
            ...
            <section class="team team-member" style="padding: 10px 0px !important">
                <div class="container">
                    ...
                    <div class="row">
						...
						?>   
                            ...
                            <ul class="gallery-filter text-center">                               
                                ...
                                <li><a href="#" data-filter=".allNews"  class="active" >All News</a></li>
                                
                           <?php foreach($newsCategory->result() as $newsCategory2){ ?>  
                                  
                                <li><a href="#"  data-filter=".cate<?php echo $newsCategory2->id?>"><?php if($this->session->userdata('weblang') == 'en'){ echo $newsCategory2->name_th; } else { echo $newsCategory2->name_en; }?></a></li>
                           <?php } ?>                     
                           </ul>
                        <?php } ?>    
                        </div>
                     ...
                     <div class="row staff-filtering33" id="divSH2" >
                     <?php $news_data = $this->news_model->get_news_data02();
						   foreach($news_data->result() as $news_data3){ 
						 
						   $dataID2 = $news_data3->user_update;	  
						   $postBy3 = $this->user_model->list_user($dataID2);	
						   foreach($postBy3->result() as $postBy4){	}	
					 ?> 
                       
                        <div class="col-xs-12 col-sm-6 col-md-4 text-center cate<?php echo $news_data3->category_id?> allNews" style="height: 330px">
                            <div class="team-mate">
                                <figure class="member-thumb">
                                    <img src="<?php if($news_data3->first_pic !=''){ echo base_url($news_data3->first_pic);  } else { $bb = 'images/e2353f39533eadca9957892d7406bc12.jpg'; echo base_url($bb); } ?>" alt="team member" class="img-responsive" style="height: 178px">
                                    <figcaption class="mask">
                                        <ul>
                                            <li><a href="<?php echo base_url('News/Detail/').$news_data3->id?>"><i class="fa fa-search-plus"></i></a></li>
                                        </ul>
                                    </figcaption>
                                </figure>
                                <div class="about">
                                    <h4><?php if($this->session->userdata('weblang') == 'en'){ echo $news_data3->topic_en; } else { echo $news_data3->topic_th; }?></h4>
									<span><h5></h5></span>
                                    
                                    <div class="sc_contact_info contact_3">
										<div class="address">
											<p style="font-size: 9pt !important">
											<i class="fa fa-calendar"></i><?php echo $this->news_model->get_dateENG($news_data3->date_add)?> &nbsp;&nbsp;
											<i class="fa fa-user"></i>by <?php echo $postBy4->user_name?>
											</p>											
										</div>
									</div>    
                                </div>
...
<script>
	$( document ).ready(function() {
		...
		var dataID = '<?php echo $cateID?>';		
		$('[data-filter=".allNews"]').removeClass('active');
		$('[data-filter=".cate'+dataID+'"]').addClass('active');	
	});		
	 ...
	 $(window).on('load', function() {	
		var dataID = '<?php echo $cateID?>';
		 // staff filtering (team member.php)
            ...
            var $galleryFullwidth = $(".staff-filtering33");
