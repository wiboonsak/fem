   ...
   <html lang="en" class="no-js"> <!--<![endif]-->
    ...
    <body class="magazine3 bordered">
        ...
        <div id="wrapper" class="main-wrapper">
            ...
            <div class="container">
                <h2 class="page-title"><?php echo $this->lang->line('Facilities');?></h2>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-offset-1  col-md-10 text-center">
                                <!--<h1>สิ่งอำนวยความสะดวก ภายในคณะการจัดการสิ่งแวดล้อม</h1>-->
                                <h1><?php echo $this->lang->line('Facilities');?></h1>
		   ...
		   <section style="padding-top: 5px !important">
           <div class="container">
                       <div class="row">
                            <div class="col-md-10 col-md-offset-1">
							    ...
							    ?>  
                                    ...
                                    <div class="col-xs-12 col-md-4 text-center item_left" style="padding-bottom: 20px !important">
                                        <div class="service-item">
                                            <figure class="service-thumb">
                                                <img class="img-responsive" alt="Service Icon" src="<?php echo base_url($facilityData2->first_pic)?>" style="height: 269px;">
                                                <div class="mask">
                                                    <a data-lightbox="service" href="<?php echo base_url($facilityData2->first_pic)?>"></a>
                                                </div>
                                            </figure>
                                            <h4><?php if($facilityData2->url !=''){ ?><a href="<?php echo $facilityData2->url?>" target="_blank"><?php }  if($this->session->userdata('weblang') == 'en'){ echo $facilityData2->topic_en; } else { echo $facilityData2->topic_th; }?><?php if($facilityData2->url !=''){ ?></a><?php } ?></h4>
                                            <!--<p>ห้องสมุด (Library) คณะการจัดการสิ่งแวดล้อม</p>-->
                                        </div>
