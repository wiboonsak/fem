        ...
        <div id="wrapper" class="main-wrapper">
            ...
            <section class="team team-member" style="padding: 10px 0px !important">
                <div class="container">
                    ...
                    <div class="row staff-filtering" id="divSH">
                       ...
                       <?php  $news_data = $this->news_model->get_news_data02(); 
						...
						?>
                        <div class="col-xs-12 col-sm-6 col-md-4 text-center allNews cate<?php echo $news_data2->category_id?>" style="height: 330px">
                            <div class="team-mate">
                                <figure class="member-thumb">
                                    <img src="<?php if($news_data2->first_pic !=''){ echo base_url($news_data2->first_pic);  } else { $bb = 'images/e2353f39533eadca9957892d7406bc12.jpg'; echo base_url($bb); } ?>" alt="team member" class="img-responsive" style="height: 178px">
                                    <figcaption class="mask">
                                        <ul>
                                            <li><a href="<?php echo base_url('News/Detail/').$news_data2->id?>"><i class="fa fa-search-plus"></i></a></li>
                                        </ul>
                                    </figcaption>
                                </figure>
                                <div class="about">
                                    <h4><?php if($this->session->userdata('weblang') == 'en'){ echo $news_data2->topic_en; } else { echo $news_data2->topic_th; }?></h4>
									<span><h5></h5></span>
                                    
                                    <div class="sc_contact_info contact_3">
										<div class="address">
											<p style="font-size: 9pt !important">
											<i class="far fa-calendar-alt"></i><?php echo $this->news_model->get_dateENG($news_data2->date_add)?> &nbsp;&nbsp;
											<i class="fa fa-user"></i>by <?php echo $postBy2->user_name?>
											</p>											
										</div>
									</div>    
                                </div>
