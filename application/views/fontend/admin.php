   ...
   <html lang="en" class="no-js"> <!--<![endif]-->
	...
	<div id="fb-root"></div>
        ...
        <div id="wrapper" class="main-wrapper">
            ...
            <div class="container">
                <h2 class="page-title"><?php echo $this->lang->line('Administator'); ?></h2>
            ...
            <section class="page-sec-head" style="padding: 40px 0px !important">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-offset-1  col-md-10 text-center">
                                <h1><?php echo $this->lang->line('Administator'); ?></h1>
                            </div>
                        </div>
                    </div>
           </section>
                ...
                <div class="container">
                    ...
                    <!--<div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-8">
                            <div class="row">
                                <div class="col-sm-4 col-md-4">
                                    <img src="images/admin/BanchongWitthayawirasak.jpg')?>" alt="" class="img-responsive">
                                ...
                                <div class="col-sm-8 col-md-8">
                                    <h3 style="font-size: 12pt; margin-bottom: 15px;"><b>Assoc. Prof. Dr. Banchong Witthayawirasak</b></h3>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4">
                            <br>
                            <h3 style="font-size: 12pt">Contact Info</h3>
                            
                            <div class="about">                                    
                                    <div class="sc_contact_info contact_3">
										<div class="address">
											<p><i class="fa fa-phone"></i>Phone: +66(0) 7428 6849 / 6800</p>
											<p><i class="fa fa-envelope"></i><a href="mailto:banjong.v@psu.ac.th" style="color:#777">banjong.v@psu.ac.th</a></p>
											<p align="left"><i class="fa fa-calendar-check-o"></i><a href="https://goo.gl/Nu0PRA" target="_blank" style="color:#777">Dean’s calendar for appointment</a></p>											
										</div>
									</div>    
                            </div>
                        </div>
                    </div>-->
					<?php $administratorData = $this->administrator_model->list_administratorData();
						
						  $n = 1;  $cvFile = '';
						  foreach($administratorData->result() as $administratorData2){	
							  
							if(($this->session->userdata('weblang') == 'en') && ($administratorData2->cv_file_en !='')){ 
											
								$cvFile = base_url().$administratorData2->cv_file_en; 
																					   
							} /*else { 
								$cvFile = '';
							}*/
											
							if(($this->session->userdata('weblang') == 'th') && ($administratorData2->cv_file_th !='')){ 
											
								$cvFile = base_url().$administratorData2->cv_file_th; 
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-8">
                            <div class="row">
                                <div class="col-sm-4 col-md-4">
                                    <img src="<?php echo base_url($administratorData2->picture)?>" alt="" class="img-responsive">
                                    <!--<ul class="social-links text-center">
                                        <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                                        <li><a href="#"><i class="fa fa-instagram"></i></a></li>
                                        <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                                ...
                                <div class="col-sm-8 col-md-8">
                                    <h3 style="font-size: 12pt; margin-bottom: 15px;"><b><?php if($this->session->userdata('weblang') == 'en'){ echo $administratorData2->name_en; } else { echo $administratorData2->name_th; }?></b></h3>
                                    <div class="divider margin20 hr4 hr_left">
                                        <span></span>
                                    </div>
									<h4><b><?php if($this->session->userdata('weblang') == 'en'){ echo $administratorData2->position_en; } else { echo $administratorData2->position_th; }?></b></h4>                                   
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4">
                            <br>
                            <h3 style="font-size: 12pt"><?php if($this->session->userdata('weblang') == 'en'){ echo 'Contact Info'; } else { echo 'ข้อมูลติดต่อ'; }?></h3>
                            
                            <div class="about">                                    
                                    <div class="sc_contact_info contact_3">
										<div class="address">
											<p><i class="fa fa-phone"></i><?php if($this->session->userdata('weblang') == 'en'){ echo 'Phone: '.$administratorData2->telephone; } else { echo 'โทร: '.$administratorData2->telephone; }?></p>
											<p><i class="fa fa-envelope"></i><a href="mailto:<?php echo $administratorData2->email;?>" style="color:#777"><?php echo $administratorData2->email;?></a></p>
											
											<?php if($cvFile != ''){ ?>
											<p align="left"><i class="far fa-file-pdf"></i><a href="<?php echo $cvFile?>" target="_blank" style="color:#777">CV</a></p>
											<?php } ?>
											
											<?php if($administratorData2->url_appointment !=''){ ?>
											<p align="left"><i class="far fa-calendar-alt"></i><a href="<?php echo $administratorData2->url_appointment;?>" target="_blank" style="color:#777"><?php if($this->session->userdata('weblang') == 'en'){ echo 'Dean’s calendar for appointment'; } else { echo 'ปฏิทินนัดหมาย'; }?></a></p>	
											<?php } ?>
										</div>
									</div>    
                            </div>
      ...
      <!--           
    				...
    				<div class="eydia-tg panel-group sc_toggle" id="sc_toggle" role="tablist" aria-multiselectable="true">
                        <div class="panel panel-default">
                            <div class="panel-heading active" role="tab" id="headingOne">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" href="#toggleOne" aria-expanded="true" aria-controls="toggleOne">
                            ...
                            <div id="toggleOne" class="panel-collapse collapse in" aria-labelledby="headingOne">
                                <div class="panel-body">
									...
									<div class="sc_contact_info contact_3">
										<div class="address">
											<h5>Dr. Warangkana Jutidamrongphan : Associate Dean of Corporate Communication<br>
												ดร. วรางคณา จุติดำรงค์พันธ์   รองคณบดีฝ่ายสื่อสารองค์กร<br>												
											</h5>
											
											<p><i class="fa fa-phone"></i>Phone: +66(0) 7428 6844</p>
											<p><i class="fa fa-envelope"></i><a href="mailto:warangkana.j@psu.ac.th">warangkana.j@psu.ac.th</a></p>
										</div>
									</div>
									</div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading active" role="tab" id="headingTwo">
                                <h4 class="panel-title">
                                    <a class="collapsed" data-toggle="collapse" href="#toggleTwo" aria-expanded="false" aria-controls="toggleTwo">
                                        งานบริการการศึกษา คณะการจัดการสิ่งแวดล้อม
                                    </a>
                                </h4>
                            </div>
                            <div id="toggleTwo" class="panel-collapse collapse" aria-labelledby="headingTwo">
                                <div class="panel-body">
                                    <p></p>
                                    ...
                                    <div class="row">
										<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
											<div class="sc_contact_info contact_3">
												<div class="address">
													<h5>คุณศศิพัชร พูลสวัสดิ์ </h5>													
													<p><i class="fa fa-phone"></i>Phone: +66 (0) 7428 6806</p>
													<p><i class="fa fa-envelope"></i><a href="mailto:sasipatch.p@psu.ac.th">sasipatch.p@psu.ac.th</a></p>
												</div>
												<hr>
												<div class="address">
													<h5>คุณคุณัญญา นพถาวร </h5>													
													<p><i class="fa fa-phone"></i>Phone: +66 (0) 7428 6803</p>
													<p><i class="fa fa-envelope"></i><a href="mailto:kunanya.n@psu.ac.th">kunanya.n@psu.ac.th</a></p>
												</div>
											</div>
										</div>
                              
										<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">							
										<h1 class="title3 margin_top50">งานบริการการศึกษา คณะการจัดการสิ่งแวดล้อม</h1>
										<div class="divider margin_bottom30 margin_top0 hr4 hr_left">
											<span></span>
										</div>
										<div class="spn_sc_iconbox_area">
											<div class="row">
												<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
													<div class="single_icon_box iconbox_large">
														<div class="iconbox_icon">
															<span class="fa fa-tasks"></span>
														</div>
														<div class="iconbox_text">
															<h2>เกี่ยวกับ บศ ทั้งหมด</h2>
															<p>Faculty of Environmental Management,  Prince of Songkla Universty</p>
															<a href="http://www2.envi.psu.ac.th/education/" target="_blank">Read More</a>
														</div>
													</div>
												</div>
												<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
													<div class="single_icon_box iconbox_large">
														...
														<div class="iconbox_text">
															<h2>หลักสูตรเฉพาะ</h2>
															<p>Faculty of Environmental Management,  Prince of Songkla Universty</p>
															<a href="http://www2.envi.psu.ac.th/education/index.php?option=com_weblinks&view=category&id=38&Itemid=62&lang=en" target="_blank">Read More</a>
														</div>
													</div>
												</div>
												<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
													<div class="single_icon_box iconbox_large">
														...
														<div class="iconbox_text">
															<h2>ตารางสอบวิทยานิพนธ์ของนักศึกษาประจำเดือน</h2>
															<p>Faculty of Environmental Management,  Prince of Songkla Universty</p>
															<a href="https://calendar.google.com/calendar/embed?src=qtr4chcp62hk3kemnnnuk2l1mg@group.calendar.google.com&ctz=Asia/Bangkok&pli=1" target="_blank">Read More</a>
														</div>
													</div>
												</div>
											</div>
           ...
           <!-- <footer class="footer">
                <div class="container">
                    <p class="copyright pull-left item_left" style="text-transform: none; font-size:9pt; font-weight: normal;"> Copyright &copy; 2018. Faculty of Environmental Management, Prince of Songkla University. <br>All rights reserved. design by <strong><a href="#">ME-FI dot com</a>.</strong></p>
