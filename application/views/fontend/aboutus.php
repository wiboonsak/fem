   ...
   <html lang="en" class="no-js"> <!--<![endif]-->
	...
	<div id="fb-root"></div>
        ...
        <div id="wrapper" class="main-wrapper">
            ...
            <div class="container">
                <h2 class="page-title"><?php echo $this->lang->line('AboutUs'); ?></h2>
                    ...
                    <div class="container">
						...
						<?php $aboutus = $this->contactus_model->get_aboutusData();
                            ...
                            <div class="col-md-offset-1  col-md-10 text-center">
                                <h1><?php echo $this->lang->line('AboutUs'); ?></h1>
                                <p><?php if($this->session->userdata('weblang') == 'en'){ echo $aboutus2->desc_en; } else { echo $aboutus2->desc_th; }?></p>
                            </div>
                        </div>
                    </div>
           </section>

           <section class="white-bg pt0">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                <ul class="about-tab-nav text-center">
                                    <li class="active">
                                        <a href="#History" aria-controls="History" data-toggle="tab"><?php echo $this->lang->line('HISTORY'); ?></a>
                                    </li>
                                    <li>
                                        <a href="#Vision" aria-controls="Vision" data-toggle="tab"><?php echo $this->lang->line('VISION'); ?></a>
                                    </li>
                                    <li>
                                        <a href="#Mission" aria-controls="Mission" data-toggle="tab"><?php echo $this->lang->line('MISSION'); ?></a>
                                    </li>
                                  </ul>
                            </div>
                        </div>
                            ...
                            <div class="col-md-offset-1 col-md-10 col-lg-offset-1 col-lg-10">
                                <div class="tab-content about-tab-content">
                                  ...
                                  <div class="tab-pane active" id="History">
                                      <div class="row">
                                            <div class="col-sm-5 col-md-4 col-lg-4">
                                                <img src="<?php echo base_url($aboutus2->history_img)?>" alt="" class="img-responsive">
                                            </div>
                                            <div class="col-sm-7 col-md-offset-1 col-md-7 col-lg-offset-1 col-lg-7">
                                                <h3><?php echo $this->lang->line('HISTORY'); ?></h3>
                                                <p><?php if($this->session->userdata('weblang') == 'en'){ echo $aboutus2->history_en; } else { echo $aboutus2->history_th; }?></p>
                                            </div>
                                      </div>
                                  </div>
                                  ...
                                  <div class="tab-pane" id="Vision">
                                      <div class="row">
                                            <div class="col-lg-4">
                                                <img src="<?php echo base_url($aboutus2->vision_img)?>" alt="" class="img-responsive">
                                            </div>
                                            <div class="col-lg-offset-1 col-lg-7">
                                                <h3><?php echo $this->lang->line('VISION'); ?></h3>
                                                <p><?php if($this->session->userdata('weblang') == 'en'){ echo $aboutus2->vision_en; } else { echo $aboutus2->vision_th; }?></p>
                                  ...
                                  <div class="tab-pane" id="Mission">
                                      <div class="row">
                                            <div class="col-lg-4">
                                                <img src="<?php echo base_url($aboutus2->mission_img)?>" alt="" class="img-responsive">
                                            </div>
                                            <div class="col-lg-offset-1 col-lg-7">
                                                <h3><?php echo $this->lang->line('MISSION'); ?></h3>
												<p>
                                                <?php if($this->session->userdata('weblang') == 'en'){ echo $aboutus2->mission_en; } else { echo $aboutus2->mission_th; }?></p>
										    </div>
                                      </div>
                                  </div>
