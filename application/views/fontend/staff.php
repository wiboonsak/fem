   ...
   <html lang="en" class="no-js"> <!--<![endif]-->
	...
	<div id="fb-root"></div>
        ...
        <div id="wrapper" class="main-wrapper">
            ...
            <div class="container">
                <h2 class="page-title"><?php echo $this->lang->line('Staff'); ?></h2>
            ...
            <section class="member-profile" style="padding-top: 0px !important">
			<?php 	$show = '1'; $dataID = '';
					$staffCategory = $this->staff_model->list_staffCategory($show);							
					$countRows = $staffCategory->num_rows();
			  
					if($countRows>0) {	
						
						foreach($staffCategory->result() as $staffCategory2){
						$cateID = $staffCategory2->id;	
			?>					
			<div id="section<?php echo $staffCategory2->id?>" style="padding-top: 60px"></div>	
                <div class="container" >			
					<h2 class="title3"><b><?php if($this->session->userdata('weblang') == 'en'){ echo $staffCategory2->name_en; } else { echo $staffCategory2->name_th; }?></b></h2>
                    <div class="divider margin20 hr7 arrow_left">
                        <span></span>
                    </div>                   
                   
                   <?php $staffData = $this->staff_model->list_staffData($cateID,$dataID);
						
						  foreach($staffData->result() as $staffData2){ 	
					?> 
                    <div class="row"><?php //echo $staffData2->sort_number?>
                        <div class="col-xs-12 col-sm-12 col-md-8">
                            <div class="row">
                                <div class="col-sm-4 col-md-4">
                                    <img src="<?php echo base_url($staffData2->picture)?>" alt="" class="img-responsive">
                                ...
                                <div class="col-sm-8 col-md-8">
									<h3 style="font-size: 12pt; margin-bottom: 15px;"><b><?php if($this->session->userdata('weblang') == 'en'){ echo $staffData2->name_en; } else { echo $staffData2->name_th; }?></b></h3>
                                    <div class="divider margin20 hr4 hr_left">
                                        <span></span>
                                    </div>
									<h4><b><?php if($this->session->userdata('weblang') == 'en'){ echo $staffData2->position_en; } else { echo $staffData2->position_th; }?></b></h4>                                   
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4">
                            ...
                            <div class="about">                                    
                                    <div class="sc_contact_info contact_3">
										<div class="address">
											<p><i class="fa fa-phone"></i><?php if($this->session->userdata('weblang') == 'en'){ echo 'Phone: '.$staffData2->telephone; } else { echo 'โทร: '.$staffData2->telephone;; }?></p>
											
											<?php if($staffData2->email !='') { ?>
											<p><i class="fa fa-envelope"></i><a href="mailto:<?php echo $staffData2->email;?>" style="color:#777"><?php echo $staffData2->email;?></a></p>
											<?php } ?>
											
											<?php if($this->session->userdata('weblang') == 'en'){ 
												
												if($staffData2->cv_file_en !=''){
											?>
											<a href="<?php echo base_url($staffData2->cv_file_en)?>" style="color:#777"><p><i class="far fa-file-pdf"></i> File CV</p></a>
											<?php }   } else { 
												
												if($staffData2->cv_file_th !=''){
											?>
											<a href="<?php echo base_url($staffData2->cv_file_th)?>" style="color:#777"><p><i class="far fa-file-pdf"></i> ไฟล์ CV</p></a>
											<?php }  } ?>											
										</div>
									</div>    
                            </div>
