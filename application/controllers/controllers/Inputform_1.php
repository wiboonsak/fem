...
class Inputform extends CI_Controller {
    ...
    public function form_group(){ 
            ...
            $this->load->view('form/form_group_js');
    }
    ...
    public function insert(){ 
        ...
        public function savedoc_1(){ 
            ...
            $datestart = $this->input->post('12');
            $end = $this->input->post('12_1');
            $dateend = $this->input->post('13');
            ...
            if($chkshowdiv=='1'){
              for($i=0;$i<count($date1_3);$i++){
                $date1_31 = $date1_3[$i];
                $detail1_31 = $detail1_3[$i];
                $price1_31 = $price1_3[$i];
                $other1_31 = $other1_3[$i];
             if($date1_31 != ''){
            $resultdoc3 = $this->Inputform_model->savedoc_3($idsaraban,$idsaraban1,$date1_31,$detail1_31,$price1_31,$other1_31,$user_update,$chk_authen);
              }
              }
            }
            if($chkshowauthor=='1'){
              for($i=0;$i<count($date1_4);$i++){
                $date1_41 = $date1_4[$i];
                $detail1_41 = $detail1_4[$i];
                $price1_41 = $price1_4[$i];
                $other1_41 = $other1_4[$i];
             if($date1_31 != ''){
            $resultdoc4 = $this->Inputform_model->savedoc_3($idsaraban,$idsaraban1,$date1_41,$detail1_41,$price1_41,$other1_41,$user_update,$chk_authen);
              }
              }
            }
            
            if($resultdoc1!=''){
                 redirect(base_url('Inputform/form_alone/'.$idsaraban.'/'.$user_id));
            }
