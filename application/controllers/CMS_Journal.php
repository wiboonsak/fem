			...
			<?php $n=1; foreach($data->result() as $data2){   
				  ...
				  $txt =''; $status2 =''; $disabled = ''; $send_mail ='';
						  ...
						  if(in_array($data2->id, $arr)){  $bb = 'checked';  }else { $bb = ''; }
							...
							if($status2 == '2'){ $disabled = 'disabled';  } else { $disabled = ''; }
...
<?php	}
	...
	public function managing_updateStatus_paper(){
		...
		if(($this->session->userdata('juserLv') =='1') || ($this->session->userdata('juserLv') =='2')){ 
			...
			if($status_process == ''){ $status_process = '0'; }
	...
	public function statusAccepted(){		
		...
		$data['statusF'] = '1';
		$data['check'] = ''; 
		$data['page_title'] = 'Status Accepted';	
	...
	public function statusRejected(){		
		...
		$data['statusF'] = '4';
		$data['check'] = '';
		$data['page_title'] = 'Status Rejected';
		$this->load->view('journal_files/paperAccepted' , $data);
		$this->load->view('journal_files/paperData_script');
	}	
	//-------------------
	public function statusArchived(){		
		...
		$data['statusF'] = '';
		$data['check'] = 'yes';
		$data['page_title'] = 'Status Archived';
		$this->load->view('journal_files/paperAccepted' , $data);
		$this->load->view('journal_files/paperData_script');
	}	
	//-------------------	
    ...
    public function edit_myData(){
        ...
        $this->load->view('journal_files/Add_user_script',$data);
    }
	//-------------------
	public function Report_by_Status(){		
		
		$data['page_title'] = 'Manuscript Status and Summary Reports';
		$data['check'] = '1';
		//$this->load->view('journal_files/paperAccepted' , $data);
	...
	public function Report_Number_Paper(){		
		...
		$data['page_title'] = 'Number of Manuscript Reports';
		$data['check'] = '2';
		//$this->load->view('journal_files/paperAccepted' , $data);
		$this->load->view('journal_files/report_view' , $data);
	}//-------------------
	public function Report_by_Author(){		
		...
		$data['page_title'] = 'Author Reports';
		$data['check'] = '3';
		//$this->load->view('journal_files/paperAccepted' , $data);
		$this->load->view('journal_files/report_view' , $data);
	}
	...
	?>	
		...
		?>	
              <tr>
				 ...
				 <td><?php echo $paperData2->title?><hr style="width: 345px; margin-bottom: -9px; border-color: #c34545; margin-top: 0px; border-width: 0px;"></td>
