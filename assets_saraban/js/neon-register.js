					...
					neonRegister.setPercentage(98, function()
					{
						...
						$.ajax({
							...
							data: {
								...
								position_level:  $("select#position_level").val(),
								position_name: 	 $("input#position_name").val()
							},
							error: function()
							{
							...
							success: function(response)
							{
								...
								var fname = response.submitted_data.fname,
									lname = response.submitted_data.lname,
								...
								setTimeout(function()
								{
									...
									if(register_status == 'username_false')
									{
										$(".login-page").removeClass('logging-in');
										neonRegister.resetProgressBar(true);

									}else 
									if(register_status == 'email_false')
									{
										$(".login-page").removeClass('logging-in');
										neonRegister.resetProgressBar(false);
									}
									else
